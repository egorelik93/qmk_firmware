...
[MAC_FN] = LAYOUT_75_ansi(
    ...
    _______,    _______,    _______,    _______,   _______,    _______,     DEBOUNCE_PRESS_DEC,   DEBOUNCE_PRESS_SHOW,    DEBOUNCE_PRESS_INC,      _______,   TOG_USB_SLP,    DEV_RESET,  SLEEP_MODE,              BAT_SHOW,   _______,
TOG_CAPS_IND,SLEEP_TIMEOUT_DEC,SLEEP_TIMEOUT_SHOW,SLEEP_TIMEOUT_INC,_______,_______,DEBOUNCE_RELEASE_DEC,DEBOUNCE_RELEASE_SHOW,DEBOUNCE_RELEASE_INC,     _______,   _______,    _______,                             _______,    _______,
    _______,                _______,    _______,   RGB_TEST,   _______,     BAT_NUM,   MO(5),      MO(4),       RGB_SPD,   RGB_SPI,    _______,                 _______,    RGB_VAI,    _______,
...
[M_LAYER] = LAYOUT_75_ansi(
    QK_REBOOT,  _______,    RF_DFU,     _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,    _______,    _______,    _______,
    _______,    _______,    _______,    _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,                _______,    _______,
    _______,    _______,    _______,    _______,   _______,    _______,     _______,   _______,    _______,     _______,   _______,    _______,     _______,                _______,    _______, 
    CAPS_WORD,  _______,    _______,    DEBOUNCE_T, _______,    GAME_MODE,   _______,   _______,   _______,    _______,   _______,    _______,                             _______,    _______,
